...
async def reedme(e):
    await e.edit(
        ...
        "\n[JulWeebProject's README.md file](https://github.com/JulianSurya/JulWeebProject/blob/master/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit("Here is my [Repo](https://github.com/JulianSurya/JulWeebProject)")
